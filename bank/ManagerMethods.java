...
public class ManagerMethods 
{
	...
	public Manager create( Map<Integer, Account> accounts, Map<String, Employee> employees, List<Account> blockedAccounts)
	{
		Scanner sc=new Scanner(System.in);
		...
		return new Manager(managerName,mobileNo,pin,accounts,employees,blockedAccounts);
	}
	...
	public void addEmployee(Manager manager) 
	{
		...
		Employee emp=new Employee(employeeName,mobileNo,pin,manager.getAccounts(),manager.getBlockedAccounts());
		emp.printDetails();
